		...
		<div class="container-fluid">
			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav">
					...
					<li   class="active"><a href="comp.php">Companies</a></li>
...
<main id="main">
	...
	<div class="container">
		<p> The following companies visit our college for recruitment.</p>
...
try {
   ...
   /* if($dbh)
    ...
    $stmt=$dbh->prepare("SELECT CompanyName FROM company");
    $stmt->execute();
