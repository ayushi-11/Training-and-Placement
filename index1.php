...
<header id="header">
	<div id="head" class="parallax" parallax-speed="2">
		<h1 id="logo" class="text-center">
			...
			<span class="title">JAYPEE INSTITUTE OF INFORMATION TECHNOLOGY</span>
...
<main id="main">
	...
	<div class="container">
		<p>
		At JIIT we foster a climate where collaboration with industry thrives, generating both breakthrough discoveries and the science and technology that can support continuous innovation and growth. With a perfect track record of very productive relationships with corporations of all sizes, from startups to mature, successful enterprises, our institutions provide the students with education, research and connections to world class faculty and corporates.
		</p>
